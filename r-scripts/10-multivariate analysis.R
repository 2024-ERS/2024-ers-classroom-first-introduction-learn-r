...
vegan::ordisurf(dca,envdat$elevation,add=T,col="brown")
vegan::ordisurf(dca,envdat$clay_cm,add=T,col="darkgreen")

# add a species contour
vegan::ordisurf(dca,vegdat$FestuRub,add=T,col="darkgreen")
...
# backshow the dendrogram and cut in in 4 communities
rect.hclust(cavg,4)
c4<-cutree(cavg,4)
c4
